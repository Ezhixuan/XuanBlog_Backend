...
class MemoCardCoreController {
  ...
  @Resource private MemoCardService memoCardService;
  ...
  @GetMapping("/list")
  public PageResponse<MemoCardVO> list(MemoQueryDTO queryDTO) {
  ...
  public BaseResponse<String> add(@RequestBody MemoCardSubmitDTO submitDTO) {
    ThrowUtils.throwIf(
        Objects.isNull(submitDTO.getBack()) || Objects.isNull(submitDTO.getFront()),
